...
class M3MultiSelectListPreferenceDialogFragmentCompat :
    ...
    companion object {
        fun newInstance(key: String?): M3MultiSelectListPreferenceDialogFragmentCompat {
            val fragment = M3MultiSelectListPreferenceDialogFragmentCompat()
            val b = Bundle(1)
