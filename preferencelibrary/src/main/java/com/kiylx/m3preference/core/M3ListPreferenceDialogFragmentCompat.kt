...
class M3ListPreferenceDialogFragmentCompat : ListPreferenceDialogFragmentCompat() {
    ...
    companion object {
        fun newInstance(key: String?): M3ListPreferenceDialogFragmentCompat {
            val fragment = M3ListPreferenceDialogFragmentCompat()
            val b = Bundle(1)
